...
# ========= CONFIG (edit these) =========
INPUT_FILE = r"E:\Temp\Ymir\agreement_lines_20260312.txt"
OUTPUT_FILE = r"E:\Temp\Ymir\agreement_lines_20260312.json"          # e.g. r"output.json" (None => print to stdout)
...
BOOL_FIELDS = {"HasLock"}
DATETIME_FIELDS = {"RegDate", "FromDate", "ToDate", "LastChanged"}
